...
/* =================================================================== */
/*  Button event handler (v7 signature)                                */
/* =================================================================== */
...
static void nes_page_refresh(lv_task_t *task)
{
    (void)task;
    if (nes_canvas_need_refresh && p_nes)
    {
...
/* =================================================================== */
/*  Lifecycle callbacks (app registration)                              */
/* =================================================================== */
